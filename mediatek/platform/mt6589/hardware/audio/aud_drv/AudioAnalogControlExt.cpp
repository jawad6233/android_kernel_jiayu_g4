...
bool AudioAnalogControlExt::getExtCodecPathStatus(void)
{
    return NO_ERROR;
}

bool AudioAnalogControlExt::getAnalogPathStatus(void)
{
    return NO_ERROR;
}

bool AudioAnalogControlExt::SetFmStatus(bool bStatus)
{
    return NO_ERROR;
}

bool AudioAnalogControlExt::GetFmStatus(void)
{
    return NO_ERROR;
}
#endif
