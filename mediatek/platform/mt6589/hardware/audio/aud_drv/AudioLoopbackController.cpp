...
#ifdef VENDOR_EDIT
/* xiang.fei@BasicDrv.Audio, 2013/02/16, Add for looptest */
    mSpkAmpLchGainCopy = 0;
    mSpkAmpRchGainCopy = 0;
#endif
}
...
#ifdef VENDOR_EDIT
/* xiang.fei@BasicDrv.Audio, 2013/02/16, Add for looptest */
    mSpkAmpLchGainCopy = mAudioAnalogInstance->GetAnalogGain(AudioAnalogType::VOLUME_HPOUTL);
    mSpkAmpRchGainCopy = mAudioAnalogInstance->GetAnalogGain(AudioAnalogType::VOLUME_HPOUTR);
#endif
...
//Jirui.kang@BasicDrv.Audio, 2013/03/15, Modify for mic to speaker loopbacktest
        ...
        mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_HPOUTL, 15);
        mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_HPOUTR, 15);
    #else
        ...
        mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_HPOUTL, 12);
        mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_HPOUTR, 12);
    ...
    #ifndef VENDOR_EDIT
    /* xiang.fei@BasicDrv.Audio, 2013/02/16, Modify for looptest */
    ...
    #else
        mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_MICAMPL, kPreAmpGainMapValue[PREAMP_GAIN_26_DB]);
        mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_MICAMPR, kPreAmpGainMapValue[PREAMP_GAIN_26_DB]);
    #endif /* VENDOR_EDIT */
    }
#endif
...
#ifdef VENDOR_EDIT
/* xiang.fei@BasicDrv.Audio, 2013/02/16, Add for looptest */
    mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_HPOUTL, mSpkAmpLchGainCopy);
    mAudioAnalogInstance->SetAnalogGain(AudioAnalogType::VOLUME_HPOUTR, mSpkAmpRchGainCopy);
#endif
#endif
