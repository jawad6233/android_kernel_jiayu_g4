...
#ifdef VENDOR_EDIT
//lvxj@MutimediaDrv.AudioAFE 2012/02/25, Add for MMI AUTO TEST looptest
...
#ifndef VENDOR_EDIT
/* xiang.fei@BasicDrv.Audio, 2013/02/28, Modify for FM */
...
#ifdef VENDOR_EDIT
//lvxj@MutimediaDrv.AudioAFE 2012/02/25, Add for MMI AUTO TEST looptest
static AudioLoopBackTest *mLoopBackTest = NULL;
#endif
...
#ifdef VENDOR_EDIT
//lvxj@MutimediaDrv.AudioAFE 2012/02/25, Add for MMI AUTO TEST looptest    
    mLoopBackTest = new AudioLoopBackTest(this); 
#endif
...
status_t AudioMTKHardware::setParameters(const String8 &keyValuePairs)
{
    ...
    if (param.getInt(keyAnalogFmEnable, value) == NO_ERROR) {
        ...
        /* xiang.fei@BasicDrv.Audio, 2012/12/22, Add for Audio */
            ...
            mAudioAnalogInstance->SetFmStatus((bool)value);
        #endif
        #endif /* VENDOR_EDIT */
    ...
    #ifdef VENDOR_EDIT
    //lvxj@MutimediaDrv.AudioAFE 2012/02/25, Add for MMI AUTO TEST looptest
    mLoopBackTest->AudioLoopBackTestMain(&param);
    #endif /*VENDOR_EDIT*/
...
#ifdef VENDOR_EDIT
//GuoLing@Prd.AudioRouting, 2013/03/27, Modify for set iMode -1 when FM is on.
#ifdef OPPO_WOLFSON_CODEC_SUPPORT
        mAudioResourceManager->setParameters(-1,0);
