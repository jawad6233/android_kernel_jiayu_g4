...
/* xiang.fei@BasicDrv.Audio, 2012/12/22, Add for Audio */
#ifdef OPPO_WOLFSON_CODEC_SUPPORT
mAudioMachineDevice->setParameters(command1, 0);
#endif
#endif /* VENDOR_EDIT */
...
/* xiang.fei@BasicDrv.Audio, 2012/12/22, Add for Audio */
#ifdef OPPO_WOLFSON_CODEC_SUPPORT  
bool AudioAnalogControl::getExtCodecPathStatus(void)
{
    return mAudioMachineDevice->getExtCodecPathStatus();
}

bool AudioAnalogControl::getAnalogPathStatus(void)
{
    return mAudioMachineDevice->getAnalogPathStatus();
}

bool AudioAnalogControl::SetFmStatus(bool bStatus)
{
    bFmStatus = bStatus;
...
bool AudioAnalogControl::GetFmStatus(void)
{
    return bFmStatus;
}
#endif
