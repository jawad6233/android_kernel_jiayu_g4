...
/* wuhongru@CameraSrv*/
    ...
    Param_T()
        ...
        , u4SceneMode(0)
#ifndef   VENDOR_EDIT
//LiPeng.Bai, 2013/08/16,Delet for facebook flash light auto model, bug id:323460
        , u4StrobeMode(0)
#else
	, u4StrobeMode(-1)
#endif
...
public:
	...
	virtual MUINT32 getWaveDetectValue(){return 0;}
	virtual MINT32 getBrightness(){return 0;}
	virtual MINT32 getWhiteBalance(){return 0;}
	virtual MUINT32 getAeParameter(){return 0;}
	virtual MINT32 getAFposition(){return 0;}	
	virtual MINT32 setScene(MUINT32 a_u4Scene){return 0;}
	virtual MUINT32 PictureProcessing(MUINT8 *frm_Addr, MUINT32 w, MUINT32 h) {return 0;}
	#endif /* VENDOR_EDIT */
