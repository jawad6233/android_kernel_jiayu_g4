...
#ifdef VENDOR_EDIT
LOCAL_SRC_FILES += $(call all-c-cpp-files-under, ./oppo)
#endif
...
#ifdef VENDOR_EDIT 
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.camadapter.docFace
#endif
#

#ifdef VENDOR_EDIT 
#Lycan.Wang@Camera.CameraSrv add for scalado libs
LOCAL_STATIC_LIBRARIES += baseapi
LOCAL_STATIC_LIBRARIES += capseng
LOCAL_STATIC_LIBRARIES += codecs
LOCAL_STATIC_LIBRARIES += cthdr3
LOCAL_STATIC_LIBRARIES += facedetector
LOCAL_STATIC_LIBRARIES += fmautorama
LOCAL_STATIC_LIBRARIES += fmclearshot
LOCAL_STATIC_LIBRARIES += fmexif
LOCAL_STATIC_LIBRARIES += fmface
LOCAL_STATIC_LIBRARIES += fmhdr2
LOCAL_STATIC_LIBRARIES += fmhdrimage
LOCAL_STATIC_LIBRARIES += fmimageenhance
LOCAL_STATIC_LIBRARIES += fmimagefusion
LOCAL_STATIC_LIBRARIES += fmlocaltimewarp
LOCAL_STATIC_LIBRARIES += fmlowlight
LOCAL_STATIC_LIBRARIES += fmnaturalflash
LOCAL_STATIC_LIBRARIES += fmphotoart
LOCAL_STATIC_LIBRARIES += fmspeedview
LOCAL_STATIC_LIBRARIES += libScaladoFace
LOCAL_STATIC_LIBRARIES += osl_gcc
LOCAL_STATIC_LIBRARIES += baseapi
LOCAL_STATIC_LIBRARIES += capseng
LOCAL_STATIC_LIBRARIES += excodecs
#endif
