...
#ifdef VENDOR_EDIT
    virtual MBOOL           handleJpegData(MUINT8* const puJpegBuf, MUINT32 const u4JpegSize, MUINT8* const puThumbBuf, MUINT32 const u4ThumbSize);
#else
...
/* xinlan.he@Prd.Camera.CameraSrv for: scalado_hdr */
#ifdef VENDOR_EDIT
class ZsdScaladoHdrShot : public ZsdShot
{
public:     ////                    Instantiation.
                                    ZsdScaladoHdrShot(
                                        char const*const pszShotName,
