...
extern "C"
sp<IShot>
createInstance_SpecialEffectShot(
...
{
    sp<IShot>       pShot = NULL;
    sp<SpecialEffectShot>  pImpShot = NULL;
    //
    //  (1.1) new Implementator.
    pImpShot = new SpecialEffectShot(pszShotName, u4ShotMode, i4OpenId, pParamsMgr);
    if  ( pImpShot == 0 ) {
        CAM_LOGE("[%s] new SpecialEffectShot", __FUNCTION__);
        goto lbExit;
    }
    //
 ...
 ******************************************************************************/
bool SpecialEffectShot::onCreate()
{
#warning "[TODO] SpecialEffectShot::onCreate()"
    bool ret = true;
    return ret;
}
 ...
 ******************************************************************************/
void SpecialEffectShot::onDestroy()
{
#warning "[TODO] SpecialEffectShot::onDestroy()"
}
 ...
 *
 ******************************************************************************/
SpecialEffectShot::SpecialEffectShot(
    char const*const pszShotName, 
    uint32_t const u4ShotMode, 
    int32_t const i4OpenId, 
    sp<IParamsManager>  pParamsMgr
 ...
 *
 ******************************************************************************/
bool SpecialEffectShot::sendCommand(
                                    uint32_t const  cmd, 
                                    uint32_t const  arg1, 
                                    uint32_t const  arg2)
{
 ...
 *
 ******************************************************************************/
bool SpecialEffectShot::onCmd_reset()
{
#warning "[TODO] SpecialEffectShot::onCmd_reset()"
    bool ret = true;
    return ret;
}
 ...
 *
 ******************************************************************************/
bool SpecialEffectShot::onCmd_capture()
{ 
    AutoCPTLog cptlog(Event_Shot_capture);
    MBOOL ret = MTRUE; 
    NSCamShot::ISingleShot *pSingleShot = NSCamShot::ISingleShot::createInstance(static_cast<EShotMode>(mu4ShotMode), "SpecialEffectShot"); 
    // 
    pSingleShot->init(); 
 ...
 *
 ******************************************************************************/
void SpecialEffectShot::onCmd_cancel()
{
    AutoCPTLog cptlog(Event_Shot_cancel);
#warning "[TODO] SpecialEffectShot::onCmd_cancel()"
}

/******************************************************************************
 *
 ******************************************************************************/
MBOOL SpecialEffectShot::fgCamShotNotifyCb(MVOID* user, NSCamShot::CamShotNotifyInfo const msg)
{
    AutoCPTLog cptlog(Event_Shot_handleNotifyCb);
    SpecialEffectShot *pSpecialEffectShot = reinterpret_cast <SpecialEffectShot *>(user); 
    if (NULL != pSpecialEffectShot) 
    {
        if (NSCamShot::ECamShot_NOTIFY_MSG_EOF == msg.msgType) 
        {
            pSpecialEffectShot->mpShotCallback->onCB_Shutter(true, 0); 
        }
    }
 ...
 *
 ******************************************************************************/
MBOOL SpecialEffectShot::fgCamShotDataCb(MVOID* user, NSCamShot::CamShotDataInfo const msg)
{
    SpecialEffectShot *pSpecialEffectShot = reinterpret_cast<SpecialEffectShot *>(user); 
    if (NULL != pSpecialEffectShot) 
    {
        ...
        {
            pSpecialEffectShot->handlePostViewData( msg.puData, msg.u4Size);  
        }
        else if (NSCamShot::ECamShot_DATA_MSG_JPEG == msg.msgType)
        {
            pSpecialEffectShot->handleJpegData(msg.puData, msg.u4Size, reinterpret_cast<MUINT8*>(msg.ext1), msg.ext2);
        }
        else if (NSCamShot::ECamShot_DATA_MSG_YUV == msg.msgType)
        {
            pSpecialEffectShot->handleYuvDataCallback(msg.puData, msg.u4Size);
        }
    }
...
*
*******************************************************************************/
MBOOL SpecialEffectShot::handlePostViewData(MUINT8* const puBuf, MUINT32 const u4Size)
{
...
#ifdef VENDOR_EDIT
#ifdef QUICK_CAPTURE
//zhiquan.huang@MMApp.Camera, 2013-04-03 Add for postview(RGB565) effect
	if(strcmp(mpParamsMgr->getStr(MtkCameraParameters::QUICK_CAPTURE_SUPPORTED),"on") == 0)
	{
		int facing = 0;
		MY_LOGD("[handlePostViewData] + (puBuf, size) = (%p, %d) effect start", puBuf, u4Size);
	...
	switch(mpParamsMgr->getOpenId()){
	    ...
	    case 1:
			...
			break;
	    default:
	        MY_LOGE("[handlePostViewData] invalid cameraId =%d not handled", mpParamsMgr->getOpenId());
	}

		PhotoArtHacker * hacker = new PhotoArtHacker(facing);
		hacker->onReceivePostview(puBuf, camState);
		hacker->getProcessedMem(puBuf, u4Size);
		MY_LOGD("[handlePostViewData] + (puBuf, size) = (%p, %d) effect end", puBuf, u4Size);
	    delete hacker;
	}
#endif
#endif /* VENDOR_EDIT */
...
*
*******************************************************************************/
MBOOL SpecialEffectShot::handleJpegData(MUINT8* const puJpegBuf, 
...
void SpecialEffectShot::getCameraState(ICameraHacker::CamState& camState)
{
...
MBOOL SpecialEffectShot::handleYuvDataCallback(MUINT8* const puBuf, MUINT32 const u4Size)
{
    int facing = 0;
    ...
    switch(mpParamsMgr->getOpenId()){
        ...
        case 1:
            ...
            break;
        default:
            MY_LOGE("[handleYuvDataCallback] invalid cameraId =%d not handled", mpParamsMgr->getOpenId());
    }
