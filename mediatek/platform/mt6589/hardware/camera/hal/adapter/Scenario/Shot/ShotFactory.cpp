...
#ifdef VENDOR_EDIT
    case eShotMode_scaladoHdr:
        //rpShot = createInstance_EvShot("EvShotCustom", u4ShotMode, i4OpenId);
        rpShot = createInstance_ZsdShot("ZsdScaladoHdrShot", u4ShotMode, i4OpenId);
        break;
#endif
    //
...
//        break;
    //
/* xinlan.he@Prd.Camera.CameraSrv */	
#ifdef VENDOR_EDIT
    case eShotMode_docSkinbeauty:
	    rpShot = createInstance_SkinBeautyShot("SkinBeautyShot", u4ShotMode, i4OpenId, pParamsMgr);
        break;
    case eShotMode_scaladoLomo:
        rpShot = createInstance_SpecialEffectShot("SpecialEffectShot", u4ShotMode, i4OpenId, pParamsMgr);
        break;
#endif
