...
#ifdef VENDOR_EDIT
    //  get [custom process] Image Buffer Provider    
    sp<IImgBufProvider> const       getCustomPvdr()const    { return getProvider(IImgBufProvider::eID_CUSTOM); }
    sp<IImgBufProvider> const       getCustom2Pvdr()const    { return getProvider(IImgBufProvider::eID_CUSTOM2); }
    sp<IImgBufProvider> const       getCustom3Pvdr()const    { return getProvider(IImgBufProvider::eID_CUSTOM3); }
    sp<IImgBufProvider> const       getCustom4Pvdr()const    { return getProvider(IImgBufProvider::eID_CUSTOM4); }                
#endif   
