...
//-----------------------------------------------------------------------------
#ifdef VENDOR_EDIT 
//zhaozhengtao modify for 13009 back_Camera sharpness 2013/04/01
#ifdef CAM_DRV_13009
#define CDP_DRV_RZ_4N_TAP_TABLE          (18)  // (15)
#else
#define CDP_DRV_RZ_4N_TAP_TABLE          (15)  // (15)
#endif
#endif
...
//zhaozhengtao modify for 13009 back_Camera sharpness 2013/04/01
#ifdef CAM_DRV_13009
#define CDP_DRV_RZ_4_TAP_RATIO_MIN       (2)//   (2)     // For this definition, it really means the denominator of MinRatio (1/2).
//
#define CDP_DRV_RZ_4N_TAP_RATIO_MAX      (2)//   (2)     // For this definition, it really means the denominator of MaxRatio (1/2).
#elif defined CAM_DRV_12083
//ZhangZhengrong@MtkCamera, 2013/04/10, Add for 12083 rear sharpness
#define CDP_DRV_RZ_4_TAP_RATIO_MIN       (2)//   (2)     // For this definition, it really means the denominator of MinRatio (1/2).
//
#define CDP_DRV_RZ_4N_TAP_RATIO_MAX      (2)//   (2)     // For this definition, it really means the denominator of MaxRatio (1/2).
#else
